...
- **URL:** https://open.regina.ca
- **License:** Open Government License - Regina (allows educational use)
- **Files:** 
  - yqrStops20251120.json (bus stops)
  - yqrRoutes20251120.json (bus routes)
...
6. Run notebook: `jupyter notebook transit_data.ipynb`
7. Execute all cells in order
